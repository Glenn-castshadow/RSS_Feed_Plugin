...
1. Download `curated-rss-aggregator-1.1.1.zip` from the `dist/` folder or a GitHub release.
...
```powershell
.\scripts\build-plugin.ps1 -Version "1.1.1"
```

The zip is written to `dist/curated-rss-aggregator-1.1.1.zip`.  
