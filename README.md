...
1. Download `curated-rss-aggregator-1.2.0.zip` from the `dist/` folder or a GitHub release.
...
```powershell
.\scripts\build-plugin.ps1 -Version "1.2.0"
```

The zip is written to `dist/curated-rss-aggregator-1.2.0.zip`.  
